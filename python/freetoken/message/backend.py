...
class UserMsg(BaseBackendMsg):
    ...
    # Online-path multimodal payload (serializable): {"pixel_values": bytes (bf16),
    # "shape": [n, patch_dim], "grid_thw": [[t, h, w], ...]}. The scheduler runs the
    # vision tower on it at prefill time.
